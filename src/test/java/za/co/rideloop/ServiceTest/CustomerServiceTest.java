...
public class CustomerServiceTest {
    ...
    void testCreateCustomer() {
        ...
        assertNotNull(saved.getCustomerID(), "Customer ID should be generated by JPA");
        assertEquals("John", saved.getFirstName(), "First name should match");
    }
    ...
    void testUpdateCustomer() {
        ...
        Customer updated = customerService.update(saved);
    ...
    void testDeleteCustomer() {
        ...
        assertThrows(RuntimeException.class, () -> customerService.read(id));
    }
    ...
    void testReadCustomer() {
        ...
        Customer saved = customerService.createCustomer(customer);
        Customer found = customerService.read(saved.getCustomerID());
